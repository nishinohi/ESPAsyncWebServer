...
void onWsEvent(AsyncWebSocket *server, AsyncWebSocketClient *client,
    ...
    if (type == WS_EVT_CONNECT) {
        ...
        if (info->final && info->index == 0 && info->len == len) {
            ...
            // data
            Serial.printf(
                "ws[%s][%u] %s-message[%llu]: ", server->url(), client->id(),
            ...
            // message is comprised of multiple frames or the frame is split
...
const char* ssid = "IRONMAN-MARK305";
